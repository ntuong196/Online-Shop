...
<html lang="en">
    ...
    <head>
        ...
        <title>Mở Gian Hàng Trên ShopCanTho.Vn</title>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Mở Shop</strong> bán hàng trên ShopCanTho.Vn</h1>
        	...
        	<div class="container">
        		<div class="row">
        			...
        			<div class="col-sm-8 col-sm-offset-2">
        				...
        				<p> Được bảo trợ bởi <strong>CÔNG TY TNHH MTV TM DV QUẢNG CÁO KEYMOU</strong>
